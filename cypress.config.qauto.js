...
module.exports = defineConfig({
  e2e: {
    baseUrl: process.env.CYPRESS_QAUTO_BASE_URL,
    ...
    setupNodeEvents(on, config) {
      ...
      config.env.APP_USER_EMAIL = process.env.CYPRESS_APP_USER_EMAIL;
      config.env.APP_USER_PASSWORD = process.env.CYPRESS_APP_USER_PASSWORD;
